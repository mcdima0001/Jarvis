...
BRIEF = "brief"
#: Не мешать игре: отдать память и процессор, не лезть в фокус (просьба
#: владельца 23.09.2026 — «тихий режим, чтобы он ел мало во время игры»).
#: Режим тут не ради вежливости: по нему решают и ядро, и скиллы, а значит
#: состояние должно быть одно на всех — как и у остальных режимов.
QUIET = "quiet"
...
_TITLES: dict[str, dict[str, str]] = {
    "ru": {DEAF: "не слушаю команды", BRIEF: "отвечаю коротко", QUIET: "не мешаю игре"},
    "en": {DEAF: "not accepting commands", BRIEF: "keeping answers short",
           QUIET: "staying out of the game's way"},
}
